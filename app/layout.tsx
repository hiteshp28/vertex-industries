...
export const metadata: Metadata = {
  title: "Vertex Industries - HDPE Monofilament Woven Mesh Solutions | Anti-Insect & Anti-Hail Nets",
  description:
    "Leading manufacturer and exporter of premium HDPE Monofilament woven mesh products including Anti-Insect Nets and Anti-Hail Nets. BIS certified quality, UV stabilized, protecting crops across India and globally.",
  keywords:
