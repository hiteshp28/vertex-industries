...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Address",
      details: ["2, Violete Villa, Ground Floor", "West Avenue Road, Santacruz (W)", "Mumbai 400 054, India"],
      action: "Get Directions",
      actionLink: "https://www.google.com/maps/search/?api=1&query=2,+Violete+Villa,+Ground+Floor,+West+Avenue+Road,+Santacruz+(W),+Mumbai+400054,+India",
    },
  ]
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to discuss your HDPE mesh requirements? Get in touch with our experts for personalized solutions and
              competitive pricing.
            </p>
          </div>
                  ...
                  <Card key={index} className="hover:shadow-lg transition-all duration-300 border-green-100">
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        <div className="p-3 bg-green-100 rounded-full">{info.icon}</div>
                        <div className="flex-1">
                          ...
                          <Button
                            ...
                            asChild
                          >
                            <a href={info.actionLink} target="_blank" rel="noopener noreferrer">{info.action}</a>
                          </Button>
                        </div>
                      </div>
                    </CardContent>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                    <p className="text-sm text-blue-700">
                      <strong>Emergency Contact:</strong> For urgent requirements, WhatsApp Mr. Pawar at 9503290174
                      anytime.
                    </p>
                  </div>
                </CardContent>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      <div>
                        ...
                        <p className="text-gray-600">
                          2, Violete Villa, Ground Floor, West Avenue Road, Santacruz (W), Mumbai 400 054
                        </p>
                      </div>
                      <Button className="mt-4 md:mt-0 bg-green-600 hover:bg-green-700 text-white" asChild>
                        <a href="https://www.google.com/maps/search/?api=1&query=2,+Violete+Villa,+Ground+Floor,+West+Avenue+Road,+Santacruz+(W),+Mumbai+400054,+India" target="_blank" rel="noopener noreferrer">Get Directions</a>
                      </Button>
                    </div>
                  </div>
                </CardContent>
